...
do
  ...
  require('blink.cmp').setup {
    keymap = {
      ...
      -- Tab to cycle through completions and navigate snippets
    ...
    completion = {
      ...
      selection = {
          -- 'auto_insert' makes the text appear as you cycle (VSCode style)
          -- 'manual' requires pressing Enter to insert the text
          preselect = true,
          auto_insert = true,
      },
    },
